...
class ScribConsumer(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data):
        ...
        initial_prompt = """Você é um assistente criador de indice de tese. Sua tarefa é redigir um índice para uma tese, o indice deve estar em uma lista python. 
   ...
   " 7.1 Síntese dos principais achados teóricos e empíricos",
    ...
    "9. Referências Bibliográficas"
        ...
        introduzir =  """Você é um assistente criador de tese. Sua tarefa é redigir uma introdução  para uma tese seguindo o formato da APA 7ª edição. 
        ...
        objectivo_geral =   """Você é um assistente criador de tese. Sua tarefa é redigir uma seção de Objetivo Geral para uma tese seguindo o formato da APA 7ª edição. 
        ...
        objectivos_especifico = """Você é um assistente criador de tese. Sua tarefa é redigir uma seção de Objetivos Específicos para uma tese seguindo o formato da APA 7ª edição. 
        ...
        Tenha em mente que a conclusão apresentada anteriormente é apenas um modelo para você seguir. Agora, desenvolva a conclusão para este tema:{question}
                    ...
                    """,
        "Referências Bibliográficas": """Você é um assistente criador de tese. Sua tarefa é redigir uma seção de bibliografia seguindo o formato da APA 7ª edição. 
